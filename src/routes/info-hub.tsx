...
function InfoHub() {
  ...
  return (
    <Show when={session().data} fallback={<LoadingScreen />}>
      <AuthenticatedLayout>
        <Show when={!cardsQuery.isPending} fallback={<LoadingScreen />}>
          <ErrorBoundary fallback={<InfoHubErrorFallback />}>
            <Show
              when={!cardsQuery.isPending || !!cardsQuery.data}
              fallback={
                <section class="flex h-full min-h-0 items-center justify-center px-4 py-5">
                  <LoadingScreen />
                </section>
              }
            >
                ...
                <div class="mb-4 flex items-center justify-between">
                  <div>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <Show
                        when={cardsQuery.isFetching && !cardsQuery.isPending}
                      >
