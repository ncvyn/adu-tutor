/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f3a832937bea9a8108b5e4e1edf9d95b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CHAT_ROOM: DurableObjectNamespace<import("./src/worker-entry").ChatRoom>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "MICROSOFT_TENANT_ID" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
